    ...
    public class MatchRepository : GenericRepository<Match>, IMatchRepository
    {
        ...
        public async Task<IEnumerable<Match>> GetByTournamentAsync(int tournamentId)
        {
            return await _dbSet
                ...
                .OrderBy(m => m.Matchday) //Ordena los partidos por la jornada de menor a mayor
                .ThenBy(m => m.MatchDate) // Si hay varios partidos con la misma jornada, ordénalos por fecha
                .ToListAsync();
        }
